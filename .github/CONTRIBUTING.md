...
3. Verify TravisCI passes on your pull request. The test configuration lives inside the [`.travis.yml`](https://github.com/emma-sax4/zoesax301/blob/master/.travis.yml) file. Read more about this repository's tests below.
