...
4. Verify TravisCI passes on your pull request. The test configuration lives inside the [`.travis.yml`](https://github.com/emmahsax/zoesax301/blob/main/.travis.yml) file. Read more about this repository's tests below.
